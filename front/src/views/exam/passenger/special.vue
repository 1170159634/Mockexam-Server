...
export default {
  ...
  cruds() {
    ...
    return CRUD({ title: '编辑', url: 'api/mockexam/question/selectIds', params: { carType: 3 }, crudMethod: { ...crudQuestion }})
  },
  ...
  watch: {
    ...
    query: {
      handler(newVal, oldVal) {
        ...
        var params = { subjectType: this.query.subjectType, carType: 3, objectiveType: this.query.objectiveType }
